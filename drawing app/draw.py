...
#root.iconbitmap('icons8-processor-24.ico')
...
frame.place(relwidth=.8, relheight=.2, relx=.1, rely=.7)
#choose color
colo="black"
a=0

clicked = StringVar()
txt= tk.Label(frame, text="Select Color",padx=10, pady=6)
txt.grid(row=1,column=0)
selectColor = tk.OptionMenu(frame, clicked,*COLORS )
selectColor.grid(row=1,column=1)
...
#color select
button = Button(frame,padx=10, pady=5,
                     fg="white", bg="#38A819", text="OK", command=ok)
button.grid(row=1,column=2)
#clear screen
button1 = Button(frame,padx=10, pady=4,
                     fg="white", bg="red", text="Clear Page", command=clear)
button1.grid(row=2,column=0)
#size up
button2 = Button(frame,padx=2, pady=4,
                     fg="white", bg="red", text="+", command=up)
button2.grid(row=2,column=1)
txt1= tk.Label(frame, text=2+a,padx=3, pady=6)
txt1.grid(row=2,column=2)
#size down
button3 = Button(frame,padx=2, pady=4,
                     fg="white", bg="red", text="-", command=down)
